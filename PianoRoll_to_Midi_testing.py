...
#***************************************************************************************************************************************************************
PianoRoll_sparse =scipy.sparse.load_npz("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/EC2/melody/bor_ps1.npz")
#with open('BestPred.csv', newline='') as csvfile:
#    piano_roll = list(csv.reader(csvfile))
...
file = open('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/PianoRolls/borps1.csv','w') 
