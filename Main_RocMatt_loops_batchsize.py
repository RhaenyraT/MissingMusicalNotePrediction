...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/batch_Target.csv", TestTarget_unshapedD, delimiter=",") 
...
for yy in range(0,len(batch)):
    for uu in range(0,repetitions):
        ...
        history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=3000, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate)),es])
    ...
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/AUCBatchsize4'+ str(yy) + '.txt', Val_AUC)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LossBatchsize4'+ str(yy) + '.txt', Loss)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/ValLossBatchsize4'+ str(yy) + '.txt', ValLoss)
...
#***************************************************************************************************************************************************************
    ...
    np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/Batchsize4_PredictedRawProbabilitiesBatchsize1.csv", PredictedRawProbabilities, delimiter=",") 
