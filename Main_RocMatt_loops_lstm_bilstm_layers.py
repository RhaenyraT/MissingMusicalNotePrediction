...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/Target.csv", TestOuput_Dense, delimiter=",") 
...
model = Sequential()
model.add(LSTM(200, return_sequences=True,input_shape=(X_train.shape[1],X_train.shape[2]))) #return_sequences=True,
model.add(Activation('relu'))
model.add(Dropout(0.3))
model.add(LSTM(300, return_sequences=True)) #return_sequences=True,
model.add(Activation('relu'))
model.add(Dropout(0.3))
...
#model.add(LSTM((100, activation='relu', dropout=0.3),input_shape=(X_train.shape[1],X_train.shape[2])))
#model.add(LSTM(150, activation='relu', return_sequences=True,dropout=0.3))
#model.add(LSTM(100, activation='relu',dropout=0.3))
#model = Sequential()
...
RawProbabilities = model.predict(TestInput)
AUC_Score=sklearn.metrics.roc_auc_score(TestOuput_Dense.flatten(), RawProbabilities.flatten())
...
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/11_AUC.csv', val_AUC)
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/11_Loss.txt', Loss)
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/11_ValLoss.txt', ValLoss)
...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/11_PredictedRawProbabilities.csv", PredictedRawProbabilities, delimiter=",") 
