...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/TargetBach.csv", TestOuput_Dense, delimiter=",") 
...
for uu in range(0,repetitions):
    ...
    #model.add(Bidirectional(LSTM(200, activation='relu', dropout=0.215,return_sequences=True),merge_mode='sum',input_shape=(X_train.shape[1],X_train.shape[2])))
   # model.add(Bidirectional(LSTM(250, activation='relu', dropout=0.0117,return_sequences=True),merge_mode='sum'))
    ...
    history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=1367, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate)),es])
    #history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=413, epochs=NEpochs, verbose=1)
    model_json = model.to_json()
    with open("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_model.json", "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_model.h5")
    ...
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_'+str(uu)+'_AUC.csv', val_AUC)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_'+str(uu)+'_Loss.txt', Loss)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_'+str(uu)+'_ValLoss.txt', ValLoss)
...
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/1L_bach_'+str(uu)+'_PredictedRawProbabilities.csv', PredictedRawProbabilities, delimiter=",") 
print(AUC_Score)
