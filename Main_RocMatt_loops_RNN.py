...
TestOutput_Dense    = TestOutput_unshaped.toarray()
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/recclayers_Target.csv", TestOutput_Dense, delimiter=",") 
...
for yy in range(0,len(regularization)):
    for uu in range(0,repetitions):
       ...
       # model.add(SimpleRNN(neurons[0],input_shape=(X_train.shape[1],X_train.shape[2]))) #return_sequences=True,
...
#            val_AUC=np.vstack((val_AUC,np.transpose(temp)))
    ...
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/ValAUC_reccbi_'+ str(yy) + '.txt', val_AUC)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/Loss_reccbi_'+ str(yy) + '.txt', loss)
    np.savetxt('C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/ValLoss_reccbi_'+ str(yy) + '.txt', valLoss)
...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/reccbi_PredictedRawProbabilities.csv", PredictedRawProbabilities, delimiter=",") 
