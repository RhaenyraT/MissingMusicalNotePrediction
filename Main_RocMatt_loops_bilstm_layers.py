...
model = Sequential()
model.add(Bidirectional(LSTM(500, activation='relu', dropout=0.73444),merge_mode='sum',input_shape=(X_train.shape[1],X_train.shape[2])))
...
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/500_AUC.csv', val_AUC)
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/500_Loss.txt', Loss)
np.savetxt('C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/500_ValLoss.txt', ValLoss)
...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Desktop/Shareernalam/validation/500_PredictedRawProbabilities.csv", PredictedRawProbabilities, delimiter=",") 
print(AUC_Score)
