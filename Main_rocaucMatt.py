...
history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=5000, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate))])
...
np.savetxt("D:/EC2/SavedModel/testmatthew/Val_AUC.csv", Val_AUC, delimiter=",") 
