...
history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=10000, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate))])
...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/Loss.csv", Loss, delimiter=",") 
#np.savetxt("D:/EC2/SavedModel/10seq/Val_AUC.csv", Val_AUC, delimiter=",") 
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/val_AUCcol.csv",Val_AUCcol, delimiter=",") 
#np.savetxt("D:/EC2/SavedModel/100100/ValCorr.csv", ValCorr, delimiter=",") 
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/ValLoss.csv", ValLoss, delimiter=",") 
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/Acc.csv", Acc, delimiter=",") 

# serialize model to JSON
model_json = model.to_json()
with open("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/model.json", "w") as json_file:
    json_file.write(model_json)
print("Saved model to disk")
# serialize weights to HDF5
model.save_weights("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/AUC_Acc/model.h5")
...
np.savetxt("C:/Users/Apoorva.Radhakrishna/Documents/Rocmatt/EC2BACKUP/SavedModels/LAYERS/NewL1/PredictedRawProbabilities.csv", PredictedRawProbabilities, delimiter=",") 
